...
data_all_summer <- left_join(data_gold_summer, data_grouped_summer, by=c("Sport", "Year", "Sex", "Season"))
data_all_winter <- left_join(data_gold_winter, data_grouped_winter, by=c("Sport", "Year", "Sex", "Season"))
...
mean_all <- c(mean_summer, mean_winter)
