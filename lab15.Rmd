...
This question is important because if there are any common features in medal-winning athletes, the data could be used to help Olympic teams that aren't scoring as well to improve (or expose faults in the system that wouldn't allow them to).
...
# Emily Archambault
I wrote the question importance and dataset description, made the team plots, wrote the team conclusion, and wrote up the team reflection. For my individual section, I compared the number of medals won across the five most populated countries in the world.

# Johnny Tamanaha
I found the dataset. For my individual section I compared the mean weight percentiles for summer and winter athletes with a permutation test. 

# Eugene Miller
In my individual section I compared height and weight regression across seasons. I helped with data import as well.

# Jingzhi Zhang
I wrote my individual section. In my individual part, I find the correlation between the age of athletes and the number of medals their country totally win in 2016.